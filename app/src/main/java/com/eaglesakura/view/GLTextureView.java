...
import com.example.alanb.cs492week1.ViewTouchEventListener;

/**
 * {@link SurfaceView} -> {@link TextureView} OpenGL ES 1.1 or OpenGL ES 2.0
 * original source from: https://github.com/eaglesakura/gltextureview.git
 */
public class GLTextureView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    /**
     * callback object. Calls this when this view received touch event.
     */
    ViewTouchEventListener viewTouchEventListener;
     ...
     * @param listener
     */
    public void setViewTouchEventListener(ViewTouchEventListener listener)
    {
        synchronized (lock) {
            if (isInitialized()) {
                throw new UnsupportedOperationException("GLTextureView Initialized");
            }
            this.viewTouchEventListener = listener;
        }
    }
    ...
    public enum RenderingThreadType {
        ...
        /**
         * Rendering on {@link GLTextureView#requestRender()}
         */
        RequestThread,
    }
    ...
    public boolean onTouchEvent(MotionEvent e)
    {
        ...
        viewTouchEventListener.onViewTouched(e);
        return true;
    }
}
